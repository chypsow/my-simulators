...
export const translations = {
  en: {
    ...
    "header.invoice-calculator": "INVOICE SIMULATOR - STEG",
    ...
    "button.calculate": "Calculate the paid capital and paid interests between 2 dates",
  ...
  fr: {
    ...
    "button.calculate": "Calculer le capital payé et les intérêts payés entre 2 dates",
    ...
    "invoice.old-reading": "Ancien indexe:",
    "invoice.new-reading": "Nouveau indexe:",
  ...
  nl: {
    ...
    "header.invoice-calculator": "FACTUUR SIMULATOR - STEG",
    "section.calculator1": "Calculator 1",
    "section.calculator2": "Calculator 2",
    ...
    "button.calculate": "Bereken het afbetaald kapitaal en de betaalde rente tussen 2 datums",
